...
class ParameterizedMonTuesTimetable(Timetable):
    ...
    def next_dagrun_info(
        ...
        *,
        ...
        return DagRunInfo(
            ...
            run_after=DateTime.combine(next_end.date(), self._schedule_at).replace(tzinfo=UTC),
        )

class FixedTimetablePlugin(AirflowPlugin):
    name = "param_mon_tues_timetable_plugin"
    timetables = [ParameterizedMonTuesTimetable]
